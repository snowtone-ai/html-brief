...
- Active goal: Maintain html-brief under pm-zero v9.4 without changing product content.
...
|---|---|---|---|---|---|---|---|
| T001 | verified | Codex CLI | none | AGENTS.md, CLAUDE.md, HANDOFF-JA.md, tasks.md, docs/, scripts/setup.mjs, scripts/verify.mjs, .gitignore | pm-zero v9.4 source-of-truth files exist and product skill content is untouched | git diff --check; node scripts/verify.mjs | 2026-05-17: node scripts/verify.mjs passed; git diff --check passed before commit. |
